...
# Devise Gem User Seeds
	user = User.create(email: "karthik@test.com", password: "karthik123", password_confirmation: "karthik123")
	user = User.create(email: "user@test.com", password: "test123", password_confirmation: "test123")
